    ...
    default:
      return (
        <div>
          ...
          <p>
            Selecciona una sección en el menú lateral para gestionar la
            plataforma.
          </p>
        </div>
      );
  ...
  return (
    <>
      ...
      <div className="layout-base">
          ...
          {SECCIONES.map((s) => (
            <button
              ...
              className={`sidebar-btn ${
                seccionSeleccionada === s.id ? "active" : ""
              }`}
            >
              {s.nombre}
            </button>
        ...
        {/* CONTENIDO PRINCIPAL */}
        <main className="content">{renderContent(seccionSeleccionada)}</main>
      </div>
    </>
  );
}
